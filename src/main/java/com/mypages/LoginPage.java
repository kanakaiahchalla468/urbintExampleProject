...
public class LoginPage extends base {
	...
	/**
	 * enters the user name, Password and clicks on Login button
	 * 
	 * @param username
	 * @param password
	 */
	...
	/**
	 * enters only the user name and clicks on login button
	 * 
	 * @param username
	 */
	...
	/**
	 * Enters only the password and clicks on login button
	 * 
	 * @param password
	 */
	...
	/**
	 * Verifies the login button isn't visible after login
	 */
	...
	/**
	 * Verifies the Events button is visible on the login page .
	 */
	...
	/**
	 * verifies the contribute button is visible on the login page
	 */
	...
	/**
	 * Verifies the Join Now button is visible on the login page
	 */
	...
	/**
	 * Verifies Chat Icon is Visible on the login page
	 */
	...
	/**
	 * Verifies the Learn button is visible on the login page
	 */
	...
	/**
	 * verifies the support button is visible on the login page
	 */
	...
	/**
	 * Verifies the drop down values in support button by mouse hovering on support
	 * button
	 */
	...
	/**
	 * Verifies the check box isn't checked on the login page by default
	 */
	...
	/*
	 * Verifies the Text displayed beside the check box
	 */
